...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'markup', 'gallery:themes/carbon/templates/album.tpl', 61, false),array('modifier', 'entitytruncate', 'gallery:themes/carbon/templates/album.tpl', 167, false),)), $this); ?>
...
<td class="gsActionIcon">
<div class="buttonCart"><?php echo $this->_reg_objects['g'][0]->itemLink(array('link' => $this->_tpl_vars['itemLink'],'title' => ($this->_tpl_vars['itemLink']['text']),'text' => "",'class' => ""), $this);?>
</div>
</td>
<?php elseif ($this->_tpl_vars['itemLink']['moduleId'] == 'comment'): ?>
<?php if ($this->_tpl_vars['itemLink']['params']['view'] == "comment.AddComment"): ?>
<td class="gsActionIcon">
<div class="buttonAddComment"><?php echo $this->_reg_objects['g'][0]->itemLink(array('link' => $this->_tpl_vars['itemLink'],'title' => ($this->_tpl_vars['itemLink']['text']),'text' => "",'class' => ""), $this);?>
</div>
</td>
...
<?php endif; ?>
<?php elseif ($this->_tpl_vars['itemLink']['moduleId'] == 'slideshow'): ?>
<td class="gsActionIcon">
...
<?php endif; ?>
<div>
<?php echo ''; ?><?php if (isset ( $this->_tpl_vars['theme']['params'][$this->_tpl_vars['frameType']] ) && isset ( $this->_tpl_vars['child']['thumbnail'] )): ?><?php echo ''; ?><?php $this->_tag_stack[] = array('container', array('type' => "imageframe.ImageFrame",'frame' => $this->_tpl_vars['theme']['params'][$this->_tpl_vars['frameType']],'width' => $this->_tpl_vars['child']['thumbnail']['width'],'height' => $this->_tpl_vars['child']['thumbnail']['height']), $this); $_block_repeat=true; $this->_reg_objects['g'][0]->container($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat); while ($_block_repeat) { ob_start();?><?php echo '<a href="'; ?><?php echo $this->_tpl_vars['linkUrl']; ?><?php echo '">'; ?><?php echo $this->_reg_objects['g'][0]->image(array('id' => "%ID%",'item' => $this->_tpl_vars['child'],'image' => $this->_tpl_vars['child']['thumbnail'],'class' => "%CLASS% giThumbnail"), $this);?><?php echo '</a>'; ?><?php $_obj_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_reg_objects['g'][0]->container($this->_tag_stack[count($this->_tag_stack)-1][1], $_obj_block_content, $this, $_block_repeat);} array_pop($this->_tag_stack);?><?php echo ''; ?><?php elseif (isset ( $this->_tpl_vars['child']['thumbnail'] )): ?><?php echo '<a href="'; ?><?php echo $this->_tpl_vars['linkUrl']; ?><?php echo '">'; ?><?php echo $this->_reg_objects['g'][0]->image(array('item' => $this->_tpl_vars['child'],'image' => $this->_tpl_vars['child']['thumbnail'],'class' => 'giThumbnail'), $this);?><?php echo '</a>'; ?><?php else: ?><?php echo '<a href="'; ?><?php echo $this->_tpl_vars['linkUrl']; ?><?php echo '" class="giMissingThumbnail">'; ?><?php echo $this->_reg_objects['g'][0]->text(array('text' => 'no thumbnail'), $this);?><?php echo '</a>'; ?><?php endif; ?><?php echo ''; ?>
...
<?php endif; ?>
<?php if (! $this->_tpl_vars['theme']['params']['itemDetails']): ?>
<?php echo $this->_reg_objects['g'][0]->block(array('type' => "core.ItemInfo",'item' => $this->_tpl_vars['child'],'showSummaries' => true,'class' => 'giInfo'), $this);?>
...
<?php endif; ?>
<?php echo $this->_reg_objects['g'][0]->block(array('type' => "core.EmergencyEditItemLink",'class' => 'gbBlock','checkBlocks' => "sidebar,album,albumUpper"), $this);?>
