<?php /* Smarty version 2.6.20, created on 2010-04-05 14:17:46
         compiled from gallery:modules/core/templates/ItemAddFromBrowser.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'gallery:modules/core/templates/ItemAddFromBrowser.tpl', 65, false),)), $this); ?>
...
<?php else: ?>
<?php if (! empty ( $this->_tpl_vars['form']['error']['upload'] )): ?>
...
?>
<?php echo $this->_tpl_vars['statusEntry']['warnings']['0']; ?>
<br/>
...
<?php $this->assign('UPLOAD_BOX_COUNT', '20'); ?>
<?php $this->assign('VISIBLE_BOX_COUNT', '2'); ?>
...
<?php endfor; endif; ?>
<?php if ($this->_tpl_vars['UPLOAD_BOX_COUNT'] > $this->_tpl_vars['VISIBLE_BOX_COUNT']): ?>
<script type="text/javascript">
// <![CDATA[
document.write('<h4><a id="addOne" href="javascript:addOne()"><?php echo $this->_reg_objects['g'][0]->text(array('text' => "More Upload Boxes...",'forJavascript' => true), $this);?>
</a></h4>');
...
if (fileIndex >= '; ?>
<?php echo $this->_tpl_vars['UPLOAD_BOX_COUNT']; ?>
<?php echo ') {
